 ...
 */
public class FilmDaoImpl__MapperGenerated extends DaoBase implements FilmDao {
  private static final Logger LOG = LoggerFactory.getLogger(FilmDaoImpl__MapperGenerated.class);

  private final FilmHelper__MapperGenerated filmHelper;
  ...
  private FilmDaoImpl__MapperGenerated(MapperContext context,
      FilmHelper__MapperGenerated filmHelper, PreparedStatement findByIdStatement,
  ...
  public Film findById(Integer id) {
    ...
    return executeAndMapToSingleEntity(boundStatement, filmHelper);
  }

  @Override
  public void save(Film film) {
    BoundStatementBuilder boundStatementBuilder = saveStatement.boundStatementBuilder();
    filmHelper.set(film, boundStatementBuilder, NullSavingStrategy.DO_NOT_SET);
  ...
  public static CompletableFuture<FilmDao> initAsync(MapperContext context) {
    ...
    try {
      ...
      FilmHelper__MapperGenerated filmHelper = new FilmHelper__MapperGenerated(context);
      if ((Boolean)context.getCustomState().get("datastax.mapper.schemaValidationEnabled")) {
        filmHelper.validateEntityFields();
      }
      List<CompletionStage<PreparedStatement>> prepareStages = new ArrayList<>();
      // Prepare the statement for `findById(java.lang.Integer)`:
      SimpleStatement findByIdStatement_simple = filmHelper.selectByPrimaryKeyParts(1).build();
      ...
      SimpleStatement saveStatement_simple = filmHelper.insert().build();
      ...
      SimpleStatement updateStatement_simple = SimpleStatement.newInstance(((DefaultUpdate)filmHelper.updateByPrimaryKey()).asCql());
      ...
      SimpleStatement deleteStatement_simple = filmHelper.deleteByPrimaryKeyParts(1).build();
      ...
      return CompletableFutures.allSuccessful(prepareStages)
          .thenApply(v -> (FilmDao) new FilmDaoImpl__MapperGenerated(context,
              filmHelper,
  ...
  public static FilmDao init(MapperContext context) {
